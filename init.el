...
(setq rcirc-default-nick "recursedoka")
(setq rcirc-default-user-name "recursedoka")
(setq rcirc-default-full-name "recurse doka")

(setq rcirc-server-alist
      '(("irc.freenode.net" :channels ("#emacs" "#gamedev"))))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "PragmataPro" :foundry "unknown" :slant normal :weight normal :height 128 :width normal)))))
